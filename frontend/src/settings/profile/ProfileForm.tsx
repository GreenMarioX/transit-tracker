...
const defaultValues: Partial<ProfileFormValues> = {
  bio: "My name is Steven and I'm a computer science student at Stony Brook University. I love to code and take public transit! My favorite Subway Line is the 7 Train and my favorite Metro Line is the Orange Line. 🚇",
  urls: [
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        />
        <FormField
          defaultValue="steven.tung@gmail.com"
          control={form.control}
          name="email"
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  <SelectItem value="steven.tung@gmail.com">steven.tung@gmail.com</SelectItem>
                  <SelectItem value="stevent@yahoo.com">stevent@yahoo.com</SelectItem>
                </SelectContent>
              </Select>
              {/* <FormDescription>
